...
export default function BORegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Account created! Please check your email to confirm your registration. Your account will need admin approval before you can access the Back-Office.")
      setError("")
      setLoading(false)
